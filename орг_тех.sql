...
--
-- Хост: localhost
-- Время создания: Сен 12 2024 г., 10:42
...
(1, '2023-06-06', 1, 'DEXP Aquilon O286', 'Перестал работать', 1, NULL, '', 2, 7),
(2, '2023-05-05', 1, 'DEXP Atlas H388', 'Перестал работать', 1, NULL, '', 3, 8),
(3, '2022-07-07', 2, 'MSI GF76 Katana 11UC-879XRU черный', 'Выключается', 2, '2023-01-01', '', 3, 9),
(4, '2023-08-02', 2, 'MSI Modern 15 B12M-211RU черный', 'Выключается', 3, NULL, '', NULL, 8),
(5, '2023-08-02', 3, 'HP LaserJet Pro M404dn', 'Перестала включаться', 3, NULL, '', NULL, 9);
...
ALTER TABLE `request`
  ...
  ADD KEY `master_id_2` (`master_id`,`client_id`);
...
--
ALTER TABLE `comments`
  ADD CONSTRAINT `comments_ibfk_1` FOREIGN KEY (`master_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `comments_ibfk_2` FOREIGN KEY (`request_id`) REFERENCES `request` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Ограничения внешнего ключа таблицы `request`
--
ALTER TABLE `request`
  ADD CONSTRAINT `request_ibfk_1` FOREIGN KEY (`request_status_id`) REFERENCES `requestStatuses` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `request_ibfk_2` FOREIGN KEY (`org_tech_type_id`) REFERENCES `orgTechTypes` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `request_ibfk_3` FOREIGN KEY (`client_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `user`
  ADD CONSTRAINT `user_ibfk_1` FOREIGN KEY (`type_id`) REFERENCES `types` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
